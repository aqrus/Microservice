...
import (
	...
	"aqrus/Microservice/gateway-api/pb/product"
...
func RunGRPCServer() {
	...
	products.RegisterProductServiceServer(s, &service.ProductServer{})
	// Register auth service implementation with the gRPC server here
	auth.RegisterAuthServiceServer(s, &service.AuthServer{})
	// Serve gRPC server
	...
	// Register auth service handler from endpoint
